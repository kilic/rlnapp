...
t := C1
let z0 := add(add(add(mulmod(s0, mload(add(pos,0)), q), mulmod(s1, mload(add(pos,32)), q)), mulmod(s2, mload(add(pos,64)), q)), t)
let z1 := add(add(add(mulmod(s0, mload(add(pos,96)), q), mulmod(s1, mload(add(pos,128)), q)), mulmod(s2, mload(add(pos,160)), q)), t)
let z2 := add(add(add(mulmod(s0, mload(add(pos,192)), q), mulmod(s1, mload(add(pos,224)), q)), mulmod(s2, mload(add(pos,256)), q)), t)
t := mulmod(z0, z0, q)
...
t := C2
s0 := add(add(add(mulmod(z0, mload(add(pos,0)), q), mulmod(z1, mload(add(pos,32)), q)), mulmod(z2, mload(add(pos,64)), q)), t)
s1 := add(add(add(mulmod(z0, mload(add(pos,96)), q), mulmod(z1, mload(add(pos,128)), q)), mulmod(z2, mload(add(pos,160)), q)), t)
s2 := add(add(add(mulmod(z0, mload(add(pos,192)), q), mulmod(z1, mload(add(pos,224)), q)), mulmod(z2, mload(add(pos,256)), q)), t)
t := mulmod(s0, s0, q)
s0 := mulmod(mulmod(t, t, q), s0, q)
t := mulmod(s1, s1, q)
s1 := mulmod(mulmod(t, t, q), s1, q)
...
s2 := mulmod(mulmod(t, t, q), s2, q)
t := C3
z0 := add(add(add(mulmod(s0, mload(add(pos,0)), q), mulmod(s1, mload(add(pos,32)), q)), mulmod(s2, mload(add(pos,64)), q)), t)
z1 := add(add(add(mulmod(s0, mload(add(pos,96)), q), mulmod(s1, mload(add(pos,128)), q)), mulmod(s2, mload(add(pos,160)), q)), t)
z2 := add(add(add(mulmod(s0, mload(add(pos,192)), q), mulmod(s1, mload(add(pos,224)), q)), mulmod(s2, mload(add(pos,256)), q)), t)
t := mulmod(z0, z0, q)
z0 := mulmod(mulmod(t, t, q), z0, q)
t := mulmod(z1, z1, q)
z1 := mulmod(mulmod(t, t, q), z1, q)
